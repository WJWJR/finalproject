...
##Intro Problem
Ever asked your partner, what do you want to do tonight? And they answer “whatever”! I don’t know about you but I  hate that answer. So, I thought I would create an application that will help provide additional ideas to the dreaded “whatever”.

##Solution
Create an application that helps a users enters category ( i.e: ‘dinner’) in search field and pulls up things todo surround that category.  

##Tech Stack
React.js
Using an event API that might hook up to google maps if possible.
...
https://www.programmableweb.com/news/93-events-apis-eventful-upcoming-google-calendar/2012/05/01
